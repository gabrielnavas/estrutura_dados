...
int main(void)
{
	...
	inserir(&listal, &listac, 0, 2, 2);
	
	inserir(&listal, &listac, 1, 2, 3);
	inserir(&listal, &listac, 1, 4, 4);
	inserir(&listal, &listac, 1, 8, 8);
	inserir(&listal, &listac, 1, 11, 11);
	
	inserir(&listal, &listac, 2, 6, 6);
