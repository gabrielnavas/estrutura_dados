...
#define VELOCIDADE_EXIBICAO 800	
#define VELOCIDADE_MSGS 680
//////////////////////////////////////////
	...
	{		
		...
		{	
			...
			if(d.inicio->prox == NULL)
			{
				...
				d.inicio->ante = NULL;
				d.inicio->prox = NULL;
				//d.fim = d.inicio; ///sera que da certo?? APAGA DEPOIS!!
			}
